...
DeclareClientEventManager(BezierCurveC0Events, BezierCurveC2Events, BezierCurveC2InterpEvents, CursorEvents,
                          InputStateEvents, PointEvents, SelectionEvents, TorusEvents, TransformEvents);
