#ifndef MCAD_BEZIER_CURVE_C2_INTERP_SERIALIZER
#define MCAD_BEZIER_CURVE_C2_INTERP_SERIALIZER
...
class BezierCurveC2InterpSerializer {
 public:
...
#endif  // MCAD_BEZIER_CURVE_C2_INTERP_SERIALIZER